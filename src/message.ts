...
- ☢️ Блокування коментарів, написаних російською мовою як мовою окупанта, разом із мотивацією переходити на українську мову.
- 🪆 Попередження про використання російської мови як мови окупанта в коментарі користувача разом із мотивацією перейти на українську.
`.trim();
