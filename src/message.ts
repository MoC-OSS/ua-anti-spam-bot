...
Привіт! 🇺🇦✌️
UA Anti Spam Bot — це безоплатний інструмент, який полегшує адміністрування Telegram-каналів і груп під час повномасштабної війни.

Можливості UA Anti Spam Bot, які можна опціонально налаштувати:
🚀 Запобігання поширенню шкідливих коментарів, які несуть небезпеку здоров’ю цивільних і військових: переміщення ЗСУ, локації “прильотів”, блокпостів тощо.
📢 Сповіщення в чаті про початок і відбій повітряної тривоги у вашому регіоні.
🤫 Вимикання чата під час повітряної тривоги.
💰 Блокування шахрайських і фішингових коментарів.
