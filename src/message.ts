...
Всі налаштування бота доступні за командою /settings
...
Я чат-бот, який:
- Запобігає поширенню стратегічної інформації: переміщення ЗСУ, локацій обстрілів, тощо.
- Сповіщає в чаті про почтак та відбій тривоги у Вашому регіоні.
- Вимикає чат під час повітряної тривоги.
- Блокує шахрайські і фішингові повідомлення, запобігає подальшому їх поширенню.
- Блокує переслані повідомлення чи повіддомлення зі згадуваннями.
- Блокує повідомлення зі зборами грошей на картки.
- Блокує повідомлення, якщо в них є будь-які посилання.
`.trim();
