...
🏰 ${
    settings.airRaidAlertSettings.state ? `${settings.airRaidAlertSettings.state} - твій вибраний регіон.` : 'Ти ще не вибрав свій регіон.'
  }
...
const airAlarmNotificationMessage = '📢 Повідомлення про повітряну тривогу';
const turnOffChatWhileAlarmButton = '✈️ Чат під час повітряної тривоги';
